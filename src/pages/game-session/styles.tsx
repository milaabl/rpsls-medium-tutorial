...
export const SolveButton = styled(LoadingButton)`
    ...
    box-shadow: ${({theme}) => `0px 0px ${theme.spacing(2)} ${theme.palette.green?.lightest}`};
...
export const SubmitMoveButton = styled(LoadingButton)`
    ...
    width: fit-content;
    box-shadow: ${({theme}) => `0px 0px ${theme.spacing(2)} ${theme.palette.blue?.lightest}`};
    border-radius: ${({theme}) => theme.spacing(1)};
    font-size: ${({theme}) => theme.typography.subtitle1.fontSize};
    padding: ${({theme}) => theme.spacing(2, 4)};
    font-weight: 600;
...
export const TimeoutButton = styled(LoadingButton)`
    ...
    box-shadow: ${({theme}) => `0px 0px ${theme.spacing(2)} ${theme.palette.orange?.main}`};
    border-radius: ${({theme}) => theme.spacing(1)};
    font-size: ${({theme}) => theme.typography.subtitle1.fontSize};
    text-transform: capitalize;
    color: ${({theme}) => theme.palette.common.black};
